...
");*/
    ...
    /*
    public static void UpdateLine(int i, Vector3 start, Vector3 end, Color? color = null, float duration = 0, bool depthTest = false)
    {
         if (depthTest){
            instance.linesZOn[i].start = start;
            instance.linesZOn[i].end = end;
            instance.linesZOn[i].color = color;
            instance.linesZOn[i].startTime = Time.time;
            instance.linesZOn[i].duration = duration;
         }
         else {
            instance.linesZOff[i].start = start;
            instance.linesZOff[i].end = end;
            instance.linesZOff[i].color = color;
            instance.linesZOff[i].startTime = Time.time;
            instance.linesZOff[i].duration = duration;
         }
    }
    */
    ...
    public static void DrawLineArrow(Vector3 start, Vector3 end, Color? color = null, float arrowHeadLength = 0.25f, float arrowHeadAngle = 20, float duration = 0, bool depthTest = false)
    {
